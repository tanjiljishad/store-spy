...
export const metadata = { title: "Terms of Service — Bellwether Intelligence" };
  ...
  return (
    <div className="mx-auto max-w-[720px] px-7 py-16">
      ...
      <div className="flex flex-col gap-4 font-mono text-[13px] leading-relaxed text-muted">
        ...
        <p>
          By creating a Bellwether Intelligence account, you agree to use the Service in
          accordance with applicable law and to not attempt to disrupt, overload, or gain
          unauthorized access to the Service or the stores it analyzes.
        </p>
        <p>
          We provide competitive intelligence derived from publicly accessible storefront data. We
          do not guarantee the accuracy, completeness, or availability of any analysis.
        </p>
